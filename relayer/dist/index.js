...
const nullifier_cache_1 = require("./nullifier-cache");
// =============================================================================
// CONSTANTS
// =============================================================================
...
class RelayerService {
    ...
    constructor(config) {
        ...
        this.nullifierCache = config.cacheConfig
            ? new nullifier_cache_1.NullifierCache(config.cacheConfig)
            : (0, nullifier_cache_1.createDisabledCache)();
...
async function main() {
    ...
    const cacheConfig = redisEnabled
        ? {
            enabled: true,
